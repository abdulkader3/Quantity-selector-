...
function App() {
  ...
  return (
    ...
    <div onClick={handelREMOVE} className="flex gap-10 ml-40 mb-20">
      <button className=' p-4 border-2 border-solid border-purple-800 rounded-sm hover:bg-red-600 transition-all '> <AiFillMinusCircle className='text-purple-800'/></button>
